...
function bzmDatePicker ($log, $document, $filter) {
    ...
    var template = '<div class="bzm-date-picker"> ' +
        ...
        '<input readonly ng-disabled="dateDisabled()" ng-class="{validationFailed : validationClass()}" id={{pickerid}} class="date-input" placeholder="{{placeholder}}" value="{{modelviewvalue}}">' +
        ...
        scope.displayPicker = function (elem) {
         ...
         console.dir(1);
           if (!scope.picker) {
            ...
            console.dir(2);
             if((scope.content && scope.content.readonly=="true") || (scope.dueDate && scope.dueDate.readonly=="true")){
                console.dir(3);
                 console.dir(scope.content)
              console.dir(scope.content.readonly)
              console.dir(scope.content.readonly=="true")
              console.dir(scope.content && scope.content.readonly=="true")
              return;
          }
            console.dir(4);
            scope.showPicker=false;
    ...
    scope.validationClass=function(){
        if((scope.content && scope.content.required) || (scope.dueDate && scope.dueDate.required)) {
